...
const SignUpForm = () => {
  return (
    <section className="lg:py-20 md:py-12 sm:py-10 py-5 relative flex-1 bg-zinc-50">
      <div className="max-w-7xl mx-auto lg:px-8 sm:px-6 px-4">
        <div className="max-w-md mx-auto lg:max-w-xl lg:mt-10 relative">
          <div className="relative lg:rounded-3xl rounded-2xl  overflow-hidden">
            <div className="sm:px-10 sm:py-12 pt-7 px-6">
              <div className="text-center">
                ...
                <a
                  href="/"
                  className="text-zinc-800 font-semibold py-4 px-8 bg-zinc-200 mt-12 w-full flex items-center justify-center rounded-xl border border-transparent 
              hover:bg-zinc-300 hover:text-zinc-700 transition-colors duration-200 ease-in-out transform"
                ...
                <a
                  href="/"
                  className="text-zinc-800 font-semibold py-4 px-8 bg-zinc-200 mt-4 w-full flex items-center justify-center rounded-xl border border-transparent 
              hover:bg-zinc-300 hover:text-zinc-700 transition-colors duration-200 ease-in-out transform"
                >
